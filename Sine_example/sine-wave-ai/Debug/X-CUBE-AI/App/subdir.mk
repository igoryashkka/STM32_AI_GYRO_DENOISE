...
../X-CUBE-AI/App/sin_wave.c \
../X-CUBE-AI/App/sin_wave_data.c \
../X-CUBE-AI/App/sin_wave_data_params.c 

OBJS += \
./X-CUBE-AI/App/network.o \
./X-CUBE-AI/App/network_data.o \
./X-CUBE-AI/App/network_data_params.o \
./X-CUBE-AI/App/sin_wave.o \
./X-CUBE-AI/App/sin_wave_data.o \
./X-CUBE-AI/App/sin_wave_data_params.o 

C_DEPS += \
./X-CUBE-AI/App/network.d \
./X-CUBE-AI/App/network_data.d \
./X-CUBE-AI/App/network_data_params.d \
./X-CUBE-AI/App/sin_wave.d \
./X-CUBE-AI/App/sin_wave_data.d \
./X-CUBE-AI/App/sin_wave_data_params.d 
...
clean-X-2d-CUBE-2d-AI-2f-App:
	-$(RM) ./X-CUBE-AI/App/network.cyclo ./X-CUBE-AI/App/network.d ./X-CUBE-AI/App/network.o ./X-CUBE-AI/App/network.su ./X-CUBE-AI/App/network_data.cyclo ./X-CUBE-AI/App/network_data.d ./X-CUBE-AI/App/network_data.o ./X-CUBE-AI/App/network_data.su ./X-CUBE-AI/App/network_data_params.cyclo ./X-CUBE-AI/App/network_data_params.d ./X-CUBE-AI/App/network_data_params.o ./X-CUBE-AI/App/network_data_params.su ./X-CUBE-AI/App/sin_wave.cyclo ./X-CUBE-AI/App/sin_wave.d ./X-CUBE-AI/App/sin_wave.o ./X-CUBE-AI/App/sin_wave.su ./X-CUBE-AI/App/sin_wave_data.cyclo ./X-CUBE-AI/App/sin_wave_data.d ./X-CUBE-AI/App/sin_wave_data.o ./X-CUBE-AI/App/sin_wave_data.su ./X-CUBE-AI/App/sin_wave_data_params.cyclo ./X-CUBE-AI/App/sin_wave_data_params.d ./X-CUBE-AI/App/sin_wave_data_params.o ./X-CUBE-AI/App/sin_wave_data_params.su
