...
#define AI_NETWORK_MODEL_SIGNATURE     "0x99b96af5643a95b16bae81b018f78f64"
...
#define AI_TOOLS_DATE_TIME   "2025-02-07T04:00:17+0200"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 320);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 320);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 384);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 384);
